(function(){
  ...
  function createUtilityScene(container, options){
    ...
    function searchScene(){
      ...
      '</g><g class="keys" transform="translate(414 244)">'+window.tk2SceneKeycaps.markup(cfg.keys,'utility')+'</g><g class="toast" transform="translate(392 20)" opacity="0"><rect width="150" height="30" rx="15" fill="#052e2b" stroke="#10b981"/><text class="toast-text" x="75" y="19" text-anchor="middle" font-family="Arial" font-size="11" font-weight="700" fill="#a7f3d0">Gefunden</text></g></svg>';
    }
    ...
    function printOpenScene(){
      ...
      '<g class="keys" transform="translate(404 248)">'+window.tk2SceneKeycaps.markup(cfg.keys,'utility')+'</g><g class="toast" transform="translate(392 18)" opacity="0"><rect width="150" height="30" rx="15" fill="#052e2b" stroke="#10b981"/><text class="toast-text" x="75" y="19" text-anchor="middle" font-family="Arial" font-size="11" font-weight="700" fill="#a7f3d0">Fertig</text></g></svg>';
    }
